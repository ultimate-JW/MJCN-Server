...
| GET | `/api/v1/chat/rooms/?category=<cat>` | O | 채팅방 폴더별 조회 (`<cat>`: 수강·졸업, 학사공지, 장학·등록금, 공모전, 취업·진로, 일반질문, 기타) |
