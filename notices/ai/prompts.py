...
# Stage 4: 키워드 추출 (spec 9.1.6) — Notice.tags 채움.
# 매칭 시 InterestArea.category / User.major / custom_text와 set 교집합 비교 (spec 5.10).
EXTRACT_TAGS_SYSTEM = """너는 대학 공지를 사용자 관심사와 매칭하기 위한 키워드 태깅 시스템이야.
